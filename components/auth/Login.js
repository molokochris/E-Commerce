...
export default function Login() {
  return (
    ...
    <Text style={{color:'blue',margin:20,fontWeight:'bold'}}>@</Text>
    <Text style={{color:'blue',margin:20,fontWeight:'bold'}}>ECommerce App</Text>
    </View>
   ...
   <View style={{margin:20}}>
    ...
    <TextInput style={{borderWidth:1,borderRadius:10, textAlign:''}}></TextInput>
    <Text style={{textAlign:'right',color:'blue',fontWeight:'bold'}}>Forgot Password?</Text>
    <TouchableOpacity>
      <View
        style={{
          marginTop: 80,
